...
# What is the name of this app?
	define('APP_NAME', 'Notes From the Road');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'hello@notesfromtheroad.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'notesfromtheroad@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'turkeyum_p4_turkeyumber_com'); 
